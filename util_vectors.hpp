...
public:
   ...
   /** @brief Standard accessor for the first coordinate writable version
    */
...
public:
    ...
    */
   float x() const { return data[0]; }
   /** @brief Standard accessor for the first coordinate writeable version
    */
   float& x()  { return data[0]; }
    ...
    */
   float y() const { return data[1]; }
   /** @brief Standard accessor for the second coordinate writeable version
    */
   float& y()  { return data[1]; }
   /** @brief Standard accessor for the third coordinate
    */
   float z() const { return data[2]; }
   /** @brief Standard accessor for the third coordinate writeable version
    */
   ...
   void SetX(float d0)  {  data[0] = d0;  }
   void SetY(float d1)  {  data[1] = d1;  }
   void SetZ(float d2)  {  data[2] = d2;  }
